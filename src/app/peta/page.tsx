  ...
  return (
    <StaticPageLayout>
      <StaticPageHeader
        eyebrow="Lokasi Desa"
        title="Peta Wilayah"
        description="Temukan lokasi Desa Karangtalun di Kecamatan Ngluwar, Kabupaten Magelang, Jawa Tengah melalui peta interaktif."
      />
      <StaticPageContainer>
        ...
        <section className="overflow-hidden rounded-[28px] border border-[var(--line)] bg-[var(--paper)] shadow-[0_14px_40px_rgba(7,57,51,0.04)] transition-all duration-300 hover:shadow-[0_22px_60px_rgba(7,57,51,0.09)]">
          <div className="aspect-[16/8] bg-[var(--paper-2)] min-h-[320px]">
            <iframe
              title="Peta Desa Karangtalun, Ngluwar, Magelang"
        ...
        <TwoColumnLayout
          main={
            <InfoBlock title="Keterangan Wilayah">
              <p>
                Desa Karangtalun terletak di Kecamatan Ngluwar, Kabupaten
                Magelang, Provinsi Jawa Tengah. Desa ini dapat diakses melalui
                jalur darat dari berbagai arah dan berada tidak jauh dari
                pusat kecamatan.
              </p>
              <p>
                Peta di atas menampilkan lokasi umum desa. Untuk koordinat
                lebih akurat beserta batas-batas wilayah administratif, silakan
                hubungi kantor desa atau merujuk pada peta wilayah resmi dari
