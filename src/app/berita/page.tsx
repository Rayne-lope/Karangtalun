      ...
      <PublicShell bgClassName="bg-[var(--cream)]" hideFooter={true}>
        <section className="mx-auto max-w-6xl px-4 py-12 sm:px-6 lg:px-8">
          ...
          <div className="mb-10 text-left">
            <span className="section-tag mb-4 inline-block">Kabar Desa & Kegiatan</span>
            <h1 className="section-title">Berita & Kegiatan</h1>
            <p className="section-desc max-w-2xl mt-4">
              Ikuti perkembangan terbaru, agenda warga, pembangunan wilayah, serta catatan dan laporan program pengabdian masyarakat di Desa Karangtalun.
            </p>
          </div>
